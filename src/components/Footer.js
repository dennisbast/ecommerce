            ...
            <div className="col-4">
              ...
              <div className="">
                <address className="text-white fs-6">
                  Example Address 12 <br /> 34443 City <br /> Germany
                </address>
                <a
                  href="tel:+12 23453454534"
                  className="mt-3 d-block mb-2 text-white"
                >
                  +12 23453454534
                </a>
                <a
                  href="mailto:d.bastkowski@gmail.com"
                  className="mt-2 d-block mb-2 text-white"
                >
                  d.bastkowski@gmail.com
                </a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Inspired by Developer's
                Corner
              </p>
            </div>
          </div>
